...
public class XORShitHi {
    public static int whatsTheHiingDifference(BufferedImage img1, BufferedImage img2) throws IOException {
            ...
            for (int c = 0; c < 3; c++) {
                for (int n = 0; n < 3; n++) {
                    for (int f = 0; f < 3; f++) {
                        ...
                        int difference = whatsTheHiingDifference(ourImage, otherImage);
